...
A **ViviComm** mindig ügyel arra, hogy megfeleljen a legfontosabb szabályoknak és előírásoknak, amikor a személyes adataidat kezeljük. Az adatok védelme nagyon fontos számunkra, és biztosítjuk, hogy minden adatot biztonságban tartsunk.

## 2. AI és Adatkezelés

A **ViviComm** használata közben az alábbi adatokat kérhetjük el tőled:

- **Személyes adat**: A neved, e-mail címed, életkorod, amit megosztasz velünk.
- **Egészségügyi adat**: A kérdéseid és a válaszok, amiket a rendszer ad, ha orvosi tanácsot kérsz.

Ha megosztod velünk ezeket az adatokat, mi biztonságosan kezeljük őket. Az adatokat csak akkor használjuk fel, ha erre a szolgáltatás működéséhez szükség van, és sosem osztjuk meg őket harmadik féllel, hacsak nem kérsz segítséget orvosi szakértőtől.

## 3. AI és Orvosi Döntések

A **BastionGPT** egy mesterséges intelligencia, amely orvosi tanácsokat ad. Az AI rendszer nem helyettesíti az orvosi szakvéleményt, és a tanácsok csak információként szolgálnak. Ha nem vagy biztos abban, amit az AI mondott, mindig kérhetsz segítséget egy orvostól, aki segít megérteni, hogy az AI által adott tanács megfelelő-e.
...
A jogszabályok szerint, ha nem szeretnéd, hogy tároljuk az adataidat, kérheted azok törlését. Az adatok törléséhez mind a te, mind a szüleid beleegyezése szükséges. Az adatokat a rendszer biztonságosan törli, és soha nem lesznek újra hozzáférhetők.
