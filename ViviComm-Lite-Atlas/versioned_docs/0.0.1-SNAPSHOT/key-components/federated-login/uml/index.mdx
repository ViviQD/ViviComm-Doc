...
## 🧩 Use Case Diagram 
<img src="/ViviCommLiteAtlas/img/diagrams/key-components/federated-login/FederatedLogin_UseCaseDiagram_UML_Complete_Final.svg" alt="Federated Login Use Case Diagram" />

---

## 🧩 Logo 
<img src="/img/logo.svg" alt="Federated Login Use Case Diagram" />
